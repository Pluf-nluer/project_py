    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Học viên'), ('teacher', 'Giáo viên'), ('admin', 'Quản trị viên')], default='student', max_length=10, verbose_name='Vai trò')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution', models.CharField(blank=True, max_length=255, null=True, verbose_name='Tổ chức cấp bằng')),
                ('level', models.CharField(blank=True, max_length=50, null=True, verbose_name='Trình độ')),
                ('language', models.CharField(default='English', max_length=50, verbose_name='Ngôn ngữ')),
                ('external_link', models.URLField(blank=True, null=True, verbose_name='Link gốc khóa học')),
                ('imported_enrollments', models.IntegerField(default=0, verbose_name='Số lượng học viên (từ dataset)')),
                ('prerequisites_text', models.TextField(blank=True, null=True, verbose_name='Yêu cầu đầu vào (Text)')),
